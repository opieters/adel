...
#
#
# A.2 construction d'un generateur de parametre phytomer (dimension + azimuth + shape leaf) a partir de dimensions calees
#
...
#
# A.4 : generateur de parametres adel a partir des donnees arvalis
#
